...
<div class="Line1_1" style="top:105px">День народження <input type="checkbox" name="BirthdayReminder" <?php if ($row['BirthdayReminder'] == 1) echo "checked=\"checked\""; ?> disabled="disabled" style="position:absolute; top:6px; left:140px" /></div>
