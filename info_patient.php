...
{
	$result = mysql_query("SELECT * FROM patient WHERE id=$_GET[id]");
	...
	$row['NotPhoned'] = $rowRem['not_phoned'];
}
...
<div class="Line1_1" style="top:105px">День народження <input type="checkbox" name="BirthdayReminder" <?php if ($row['BirthdayReminder'] == 1) echo "checked=\"checked\""; if ($row['Description'] != "") echo " disabled=\"disabled\""; ?> style="position:absolute; top:6px; left:140px" /></div>
...
<select name="VisitDay" class="SelectInputLine" <?php if ($row['Description'] != "") echo "disabled=\"disabled\"";?> style="left:1px; width:45px">
...
<select name="VisitMonth" class="SelectInputLine" <?php if ($row['Description'] != "") echo "disabled=\"disabled\"";?> style="left:51px; width:45px">
...
<select name="VisitYear" class="SelectInputLine" <?php if ($row['Description'] != "") echo "disabled=\"disabled\"";?> style="left:101px; width:60px">
...
if (!isset($_GET['add']))
{
	if ($row['VisitMiss'] > 0 && !isset($_GET['add']))
		echo "<input type=\"submit\" value=\"П\" disabled=\"disabled\" title=\"$row[VisitMiss]\" style=\"position:absolute; top:1px; left:180px\" />";
?>

<input type="submit" <?php if ($row['VisitRemind'] == 1) echo "name=\"visit_your_own_minus\" value=\"C-\""; else echo "name=\"visit_your_own_plus\" value=\"C+\""; ?> <?php echo ( $row['VisitDay'] == 0 ? "disabled=\"disabled\"" : ""); ?> style="position:absolute; top:1px; left:200px" />

<input type="submit" <?php if ($row['NotPhoned'] == 1) echo "name=\"not_phoned_minus\" value=\"Н-\""; else echo "name=\"not_phoned_plus\" value=\"Н+\""; ?> <?php echo ($row['VisitDay'] == 0 ? "disabled=\"disabled\"" : ""); ?> style="position:absolute; top:1px; left:231px" />
<?php 
}
?>
</div>
...
<input type="submit" name="archive" value="В старий архів" <?php if (isset($_GET['add'])) echo "disabled=\"disabled\" style=\"visibility:hidden\""; else echo "style=\"position:absolute; top:1px; left:21px;\""; ?> />
</div>
...
<input type="submit" name="add_reception" value="Додати" <?php if ($row['Description'] != "") echo "disabled=\"disabled\""; ?> style="position:absolute; top:1px; left:400px" />
</div>
</form>
</div>
